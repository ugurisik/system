...
function dhtmlXToolbarObject(baseId, skin) {
    ...
    this.loadXML = function (xmlFile, onLoadFunction) {
        if (onLoadFunction != null) this._doOnLoad = function () {
            onLoadFunction();
        }
            ...
            if (root.childNodes[q].tagName == "item") {
                ...
                for (var e = 0; e < root.childNodes[q].childNodes.length; e++) {
                    if (root.childNodes[q].childNodes[e].tagName == "item" && itemData.type == "buttonSelect") {
                        ...
                        try {
                            u.itemText = root.childNodes[q].childNodes[e].getElementsByTagName("itemText")[0].firstChild.nodeValue;
                        } catch (k) {
                        }
                        ;
                        ...
                        for (var w = 0; w < h.length; w++) {
                            ...
                            var r = {};
                            try {
                                r.name = h[w].getAttribute("name");
                            } catch (k) {
                                r.name = "";
                            }
                            try {
                                r.value = h[w].firstChild.nodeValue;
                            } catch (k) {
                                r.value = "";
                            }
                    ...
                    if (root.childNodes[q].childNodes[e].tagName == "userdata") {
                        var u = {};
                        try {
                            u.name = root.childNodes[q].childNodes[e].getAttribute("name");
                        } catch (k) {
                            u.name = "";
                        }
                        try {
                            u.value = root.childNodes[q].childNodes[e].firstChild.nodeValue;
                        } catch (k) {
                            u.value = "";
                        }
    ...
    this._addItemToStorage = function (itemData, pos) {
        ...
        if (itemData.userdata) {
            for (var q = 0; q < itemData.userdata.length; q++) this.setUserData(id, itemData.userdata[q].name, itemData.userdata[q].value);
        }
    }
    /* random prefix */
    ...
    if (this._spacer != null) {
        ...
        if (this.base == this.objPull[nti].obj.parentNode) {
            ...
            while (doMove) {
                ...
                if (doMove) {
                    if (this._spacer.childNodes.length > 0) this._spacer.insertBefore(this.base.childNodes[q], this._spacer.childNodes[0]); else this._spacer.appendChild(this.base.childNodes[q]);
                }
            }
            this._spacer.idd = nextToId;
            this._fixSpacer();
...
dhtmlXToolbarObject.prototype._fixSpacer = function () {
    ...
    if (_isIE && this._spacer != null) {
        ...
        var k = this._spacer;
        window.setTimeout(function () {
            k.style.borderLeft = "0px solid #a4bed4";
            k = null;
        }, 1);
    }
}
...
dhtmlXToolbarObject.prototype._buttonObject = function (that, id, data) {
    ...
    this.obj[that._isIPad ? "ontouchend" : "onmouseup"] = function (e) {
        ...
        if (that.anyUsed != "none") {
            if (that.anyUsed != this.idd) return;
        }
        var t = that.anyUsed;
        this._doOnMouseUp();
...
dhtmlXToolbarObject.prototype._buttonSelectObject = function (that, id, data) {
    ...
    if (this.openAll == true) {
        ...
        this.obj.onclick = function (e) {
            ...
            if (self.obj.extAction) try {
                window[self.obj.extAction](id);
            } catch (e) {
            }
            ;
    ...
    this._separatorButtonSelectObject = function (id, data, pos) {
        ...
        this.obj.tr.onselectstart = function (e) {
            e = e || event;
            e.returnValue = false;
            return false;
        }
        ...
        this.obj.td.onselectstart = function (e) {
            e = e || event;
            e.returnValue = false;
            return false;
        }
        ...
        this.obj.sep.onselectstart = function (e) {
            e = e || event;
            e.returnValue = false;
            return false;
        }
    ...
    this._buttonButtonSelectObject = function (id, data, pos) {
        ...
        this.obj.td_a.onselectstart = function (e) {
            e = e || event;
            e.returnValue = false;
            return false;
        }
        ...
        this.obj.td_b.onselectstart = function (e) {
            e = e || event;
            e.returnValue = false;
            return false;
        }
...
dhtmlXToolbarObject.prototype._buttonTwoStateObject = function (that, id, data) {
    ...
    this.obj[that._isIPad ? "ontouchstart" : "onmousedown"] = function (e) {
        ...
        var id = this.idd.replace(that.idPrefix, "");
        if (this.extAction) try {
            window[this.extAction](id, this.pressed);
        } catch (e) {
        }
        ;
        ...
        if (this.obj.pressed != state) {
            ...
            if (callEvent == true) {
                ...
                if (this.obj.extAction) try {
                    window[this.obj.extAction](id, this.obj.pressed);
                } catch (e) {
                }
                ;
...
function dhtmlXMenuObject(baseId, skin) {
        ...
        for (var q = 0; q < i.length; q++) {
            if ((this.idPull[i[q]] != null) && (i[q] != id)) {
                if (this.itemPull[i[q]]["state"] == "enabled") {
                    this.idPull[i[q]].className = "sub_item";
                }
            }
        }
        // hide polygons
	...
	*/
     ...
     */
    this.loadXML = function (xmlFile, onLoadFunction) {
        if (onLoadFunction) this._doOnLoad = function () {
            onLoadFunction();
        };
        this.callEvent("onXLS", []);
        this._xmlLoader.loadXML(xmlFile);
...
dhtmlXMenuObject.prototype._renderToplevelItem = function (id, pos) {
	...
	*/
    if (pos != null) {
        pos++;
        if (pos < 0) pos = 0;
        if (pos > this.cont.childNodes.length - 1) pos = null;
    }
...
dhtmlXMenuObject.prototype._updateItemImage = function (id, levelType) {
    ...
    if (isTopLevel) {
        for (var q = 0; q < this.idPull[id].childNodes.length; q++) {
            try {
                if (this.idPull[id].childNodes[q].className == "dhtmlxMenu_TopLevel_Item_Icon") imgObj = this.idPull[id].childNodes[q];
            } catch (e) {
            }
        }
    } else {
...
dhtmlXMenuObject.prototype.isContextZone = function (zoneId) {
    ...
    if (this.contextZones[zoneId] != null) {
        if (this.contextZones[zoneId] == document.getElementById(zoneId)) isZone = true;
    }
    return isZone;
}
...
dhtmlXMenuObject.prototype._renderSublevelItem = function (id, pos) {
    ...
    if (pos != null) {
        pos++;
        if (pos < 0) pos = 0;
        if (pos > polygon.tbd.childNodes.length - 1) pos = null;
    }
...
dhtmlXMenuObject.prototype.setItemText = function (id, text) {
    ...
    if ((this.itemPull[id] != null) && (this.idPull[id] != null)) {
        ...
        if (this.itemPull[id]["parent"] == this.idPrefix + this.topId && !this.context) {
            ...
            for (var q = 0; q < this.idPull[id].childNodes.length; q++) {
                try {
                    if (this.idPull[id].childNodes[q].className == "top_level_text") tObj = this.idPull[id].childNodes[q];
                } catch (e) {
                }
            }
...
dhtmlXMenuObject.prototype.setHotKey = function (id, hkey) {
    ...
    var hkObj = null;
    try {
        if (this.idPull[id].childNodes[this._rtl ? 0 : 2].childNodes[0].className == "sub_item_hk") hkObj = this.idPull[id].childNodes[this._rtl ? 0 : 2].childNodes[0];
    } catch (e) {
    }
    ...
    for (var q = 0; q < subIds.length; q++) {
        if (this.idPull[subIds[q]] != null) {
            if (this.itemPull[subIds[q]]["state"] == "enabled") {
                this.idPull[subIds[q]].className = "dhtmlxMenu_" + this.skin + "_SubLevelArea_Item_Normal";
            }
        }
    }
}
...
dhtmlXMenuObject.prototype._addUpArrow = function (id) {
    ...
    arrow.over = false;
    arrow.onselectstart = function (e) {
        e = e || event;
        e.returnValue = false;
        return false;
    }
    arrow.oncontextmenu = function (e) {
        e = e || event;
        e.returnValue = false;
        return false;
    }
...
dhtmlXMenuObject.prototype._getRadioImgObj = function (id) {
    try {
        var imgObj = this.idPull[this.idPrefix + id].childNodes[(this._rtl ? 2 : 0)].childNodes[0]
    } catch (e) {
        var imgObj = null;
    }
    return imgObj;
...
dhtmlXMenuObject.prototype._updateCheckboxImage = function (id) {
    ...
    try {
        this.idPull[this.idPrefix + id].childNodes[(this._rtl ? 2 : 0)].childNodes[0].className = "sub_icon " + this.itemPull[this.idPrefix + id]["imgen"];
    } catch (e) {
    }
}
