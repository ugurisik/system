...
dhtmlxSpreadSheet.prototype = {
    ...
    init: function () {
        ...
        this.grid.doClick = function () {
            return self.doClick.apply(self.grid, arguments);
        };
