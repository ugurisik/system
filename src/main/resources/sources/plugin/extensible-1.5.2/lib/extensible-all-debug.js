        ...
        this.monthly = new Extensible.calendar.recurrenceBase({
            ...
            getValue: function () {
                ...
                if (idx > -1) {
                    switch (idx) {
                        case 0:
                            return ';BYMONTHDAY=' + Ext.Date.format(dt, 'j');
                        case 1:
...
Ext.define('Extensible.calendar.CalendarPanel', {
    ...
    initComponent: function () {
        ...
        //
        // : Pull the configs for the toolbar/buttons out to the prototype for overrideability
        //
    ...
    onJumpClick: function () {
        ...
        if (dt !== '') {
            ...
            this.updateNavState();
            // : check that view actually changed:
            this.fireViewChange();
        }
    },
