package defsu.system.server;

import defsu.system.SystemApplication;
import defsu.system.server.core.ConnectionCore;
import defsu.system.server.core.HttpCore;
import defsu.system.server.endpoints.MainPage;
...
public class ServerManagment {
    ...
    public static void main(String[] args) {
        ...
        for (String pack : packages) {
            Reflections reflections = new Reflections("defsu.system.server.endpoints." + pack);
            reflections.getSubTypesOf(HttpCore.class).forEach(httpCore -> {
                try {
                    ...
                    System.out.println("endpoint;"+className);
