...
import defsu.system.server.maps.MapTaxOffice;

import java.util.Date;

public class TaxOffice extends MapTaxOffice implements SuRecord {
    public boolean empty = true;
    private static SuField.SuFieldList _fields;
    private String PRIMARY_KEY = "taxofficePK";
